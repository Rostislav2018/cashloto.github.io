...
$users_roulette_koll = mysql_query("SELECT * FROM `p_roulette_users_game_4` $q",$db) or die(mysql_error());
...
var mess_interval;
	  ...
	  event.preventDefault();
		...
		$.ajax({
			url: '/ajax/check_of_bet_room_4.php',
			type: "POST",
...
<input type="text" placeholder="Сумма" style="width:100px;" value="1" name="sum_bet">
