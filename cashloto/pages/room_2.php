...
$users_roulette_koll = mysql_query("SELECT * FROM `p_roulette_users_game_2` $q",$db) or die(mysql_error());
...
<div class="decs_text" style="padding: 0px;">Максимальное количество участников - 10. Выигрывают 7 из 10 участников. Победители определяются по абсолютной случайности (рандом) и делят между собой весь банк. Ставка фиксирована - 5 рублей. Вероятность выигрыша в этой комнате, равна 70%. </div>
...
<input class="knop" style="width:207px;" type="submit" value="Сделать ставку (5 RUB)" >
